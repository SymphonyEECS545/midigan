...
# Load all definitions from files ops.py and utils.py
from ops import *
from utils import *

# MidiNet Class defined with methods that encompass the entire GAN and its properties
class MidiNet(object):
    # initialization of hyper_parameters on creating an object of MidiNet. This is done in main.py Line 52
